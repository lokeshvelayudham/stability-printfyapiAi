...
access_token = "PRINTFY-API-KEY"

# Find your shop ID by running this: curl -X GET https://api.printify.com/v1/shops.json --header "Authorization: Bearer API KEY"
...
#    USE POSTMAN API TO FIND THE PRINT PROVIDER
